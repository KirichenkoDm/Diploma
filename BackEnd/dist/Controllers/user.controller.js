...
const enums_1 = require("../Tools/enums");
const user_service_1 = require("../Sevices/user.service");
const decorators_1 = require("../Tools/decorators");
let UserController = class UserController {
    ...
    async signIn(response, email, password) {
        try {
    ...
    async getAllCourseUsers(response, courseId, role) {
        try {
